...
# Edge Impulse library for ECG Arrhythmia Detector

This is a C++ library that lets you run the impulse for "ECG Arrhythmia Detector" (https://studio.edgeimpulse.com/studio/958753) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
